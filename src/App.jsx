...
async function sendPhotoToAdmin(base64, caption, uid, stars) {
  ...
  try {
    ...
    await fetch(`https://api.telegram.org/bot${BOT_TOKEN}/sendPhoto`, { method: "POST", body: form1 });
...
function BuyFlow({ onBack, showToast, user, initialPkg }) {
  ...
  async function submitOrder() {
    ...
    await sendPhotoToAdmin(receiptPhoto, caption, user.id, currentPkg.stars);
    setSending(false);
    setStep("success");
  }
